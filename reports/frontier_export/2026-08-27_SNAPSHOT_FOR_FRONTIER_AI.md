...
|---|---|---|---|---|---|---|---|
| **Google Gemini 2.5 Flash** | Google | `workhorse` | 1,048,576 tok | 120.5 ms | 🆓 GRATIS | $0.0 / $0.0 | **78.4 / 100** |
...
|:---:|---|---|---|:---:|:---:|---|
| #2 | **Anthropic Claude 3.7 Sonnet** | Anthropic | `frontier` | 92.5 / 100 | 1392 | $3.0 / $15.0 |
...
- ⚪ [EXTERNO] **Anthropic Claude 3.7 Sonnet** (Anthropic): Score **92.5/100** · Contexto: 200,000 tokens

### ⚡ Top Caballos de Batalla (Workhorses de Alta Eficiencia)
- 🟢 [EN MI PC] **Google Gemini 2.5 Flash** (Free Tier): Eficiencia **88.0/100** · Contexto: 1,048,576 tokens
