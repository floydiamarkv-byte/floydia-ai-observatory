...
Soporta Round-Robin ponderado, enfriamiento temporal ante HTTP 429 y Failover automático con thread-safety (Fix V-12).
"""
...
class KeyPoolManager:
    """Gestiona el ciclo de vida y rotación de claves para múltiples cuentas de forma thread-safe."""
    ...
    def get_next_healthy_key(self, provider: str) -> Optional[Dict[str, str]]:
        ...
        cuentas en enfriamiento por HTTP 429. Protegido por lock.
        """
        with self._lock:
